...
marker="$prefix/.keel-dynamic-$version-v17"
...
printf '%s\n' "zsh=$version" "dynamic=1" "patch=semantic-anchors-v1" "abi=3" "module-exports=v1" "cflags=probe-compat-v1" "tcsetpgrp=assumed-v1" > "$marker"
